                        ...
                        return (
                            <div className="pollc">
                                ...
                                <div>
                                    ...
                                    <button className="Btn2" style={{ marginLeft: '53%' }} aria-controls={open ? 'basic-menu' : undefined}
                                        aria-haspopup="true"
                                        aria-expanded={open ? 'true' : undefined}
                                        onClick={handleClick}>Share Chain</button>
                                    <Menuu
                                        id="basic-menu"
                                        anchorEl={anchorEl}
                                        open={open}
                                ...
                                ><div className="pollc"> <QRCode value={`http://192.168.3.21:3000/poll/${ poll._id }`} style={{ marginTop: '25px' }} /></div>
                                </Modal>
                            </div>
                        );
                    })
