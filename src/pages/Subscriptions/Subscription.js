    ...
    return (
        <div className='FlexBG' style={{ justifyContent: 'center' }}>
            ...
            <div className="subCard">
                <img src={Img} style={{ height: '20%', position: 'relative', left: '1px', marginTop: '0px' }} alt='VoteaBLE Img' />
                <h1>Free</h1>
                <h2 style={{ marginBottom: '0px', marginTop: '-10px' }}>US $0.00/ Month</h2>
                <ul>
            ...
            <div className="subCard">
                ...
                <h2 style={{ marginBottom: '0px', marginTop: '-10px' }}>US $10.00/ Month</h2>
                <ul>
            ...
            <div className="subCard">
                <img src={Img} style={{ height: '20%', position: 'relative', left: '1px' }} alt='VoteaBLE Img' />
                <h1>6 Month Access</h1>
                <h2 style={{ marginBottom: '0px', marginTop: '-10px' }}>US $8.00/ Month</h2>
                <ul>
                    <li>Create unlimited polls per user</li>
                    <li>Vote in an unlimited number of polls</li>
                    <li>Poll Chains included</li>
            ...
            <div className="subCard">
                <img src={Img} style={{ height: '20%', position: 'relative', left: '1px' }} alt='VoteaBLE Img' />
                <h1>1 Year Access</h1>
                <h2 style={{ marginBottom: '0px', marginTop: '-10px' }}>US $5.00/ Month</h2>
                <ul>
                    <li>Create unlimited polls per user</li>
                    <li>Vote in an unlimited number of polls</li>
                    <li>Poll Chains included</li>
